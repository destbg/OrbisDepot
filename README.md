...
- **Field Crafting** — While you have a Sigil in your inventory, the pocket crafting window pulls ingredients directly from void storage. Placed blocks are automatically replenished from storage too.
