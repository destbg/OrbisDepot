...
public sealed interface OrbisDepotStorageContext permits OrbisDepotStorageContext.Depot, OrbisDepotStorageContext.Sigil {
    ...
    record Depot(@Nonnull String posKey, @Nonnull UUID ownerUUID, @Nonnull World world) implements OrbisDepotStorageContext {
        @Override
        @Nonnull
        ...
        public float getUploadProgress() {
            ...
            return Math.min(1f, timer / Constants.UPLOAD_INTERVAL_SECONDS);
        }
